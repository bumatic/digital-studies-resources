...
toc: true
seo:
  title: "Glossary" # custom title (optional)
  description: ""
...
**Description**: The degree of a node is the number of edges that are adjacent to the node. [https://github.com/gephi/gephi/wiki/Degree](https://github.com/gephi/gephi/wiki/Degree) See: Average Degree (Mittlerer Grad) and Average Weighted Degree (Mittlerer gewichteter Grad)
